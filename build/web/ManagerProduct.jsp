        ...
        <div class="container">
            <div class="grid wide table-wrapper">
                <div class="row container_header">
                    ...
                    <div class="col l-3">
                        <h2><b><a class="container_header_txt" style="text-decoration: none" href="sold">Ðã bán</a></b></h2>
                    </div>
                    <div class="col l-3">
                        <a href="add" class="container_header_add" data-toggle="modal"><i class="fa-solid fa-circle-plus"></i><span>&nbsp;Thêm sản phẩm mới</span></a>
                    </div>
                </div>
                <div class="table">
