<%-- 
    Document   : editClient
    Created on : 23-11-2023, 22:40:09
    Author     : chuva
--%>
...
<html>
    ...
    <body>
        <div id="logreg-forms">
            <form action="editClient" method="post" class="form-signup" style="display: block">
                ...
                <a href="client" id="cancel_signup" class="signup_back"><i class="fa-solid fa-angle-left"></i>&nbsp;Quay lại</a>
            </form>
            <br>
        </div>
    </body>
